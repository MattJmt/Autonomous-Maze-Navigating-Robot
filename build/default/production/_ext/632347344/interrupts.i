# 1 "../lab-5-serial-communication-hudson-matthias/interrupts.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../lab-5-serial-communication-hudson-matthias/interrupts.c" 2
...
# 2 "../lab-5-serial-communication-hudson-matthias/interrupts.c" 2
...
void Interrupts_init(void);
# 3 "../lab-5-serial-communication-hudson-matthias/interrupts.c" 2
